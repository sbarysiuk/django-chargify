...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Coupon'
        db.create_table('chargify_coupon', (
            ...
            ('allow_negative_balance', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('recurring', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('coupon_end_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('chargify', ['Coupon'])


    def backwards(self, orm):
        
        # Deleting model 'Coupon'
        db.delete_table('chargify_coupon')
