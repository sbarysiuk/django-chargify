...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Coupon.amount'
        db.add_column('chargify_coupon', 'amount', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=15, decimal_places=2), keep_default=False)

        # Adding M2M table for field coupons on 'Subscription'
        db.create_table('chargify_subscription_coupons', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('subscription', models.ForeignKey(orm['chargify.subscription'], null=False)),
            ('coupon', models.ForeignKey(orm['chargify.coupon'], null=False))
        ))
        db.create_unique('chargify_subscription_coupons', ['subscription_id', 'coupon_id'])


    def backwards(self, orm):
        
        # Deleting field 'Coupon.amount'
        db.delete_column('chargify_coupon', 'amount')

        # Removing M2M table for field coupons on 'Subscription'
        db.delete_table('chargify_subscription_coupons')
