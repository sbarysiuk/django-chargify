...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'QuantityComponent'
        db.create_table('chargify_quantitycomponent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('component_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('allocated_quantity', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal('chargify', ['QuantityComponent'])

        # Adding field 'Subscription.component'
        db.add_column('chargify_subscription', 'component', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chargify.QuantityComponent'], unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'QuantityComponent'
        db.delete_table('chargify_quantitycomponent')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 27, 3, 41, 27, 928575)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 27, 3, 41, 27, 928393)'}),
