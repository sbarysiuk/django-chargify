...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Customer._phone'
        db.alter_column('chargify_customer', '_phone', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))


    def backwards(self, orm):
        
        # Changing field 'Customer._phone'
        db.alter_column('chargify_customer', '_phone', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 1, 4, 46, 10, 204134)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 1, 4, 46, 10, 204045)'}),
        ...
        'chargify.customer': {
            ...
            '_phone': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True'}),
