...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('chargify_transaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('chargify_id', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True, blank=True)),
            ('transaction_type', self.gf('django.db.models.fields.CharField')(default='', max_length=15, null=True, blank=True)),
            ...
            ('ending_balance_in_cents', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('memo', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
            ('success', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='transactions', null=True, to=orm['chargify.Product'])),
            ('subscription', self.gf('django.db.models.fields.related.ForeignKey')(related_name='transactions', null=True, to=orm['chargify.Subscription'])),
        ))
        db.send_create_signal('chargify', ['Transaction'])


    def backwards(self, orm):
        
        # Deleting model 'Transaction'
        db.delete_table('chargify_transaction')
